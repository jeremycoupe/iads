...
if excludeEarlyDays:
	if filterTail:
		stSaveFig = 'figs/' + versionNumber + stSave + 'FilterDaysFilterTailWithArrival.png'
	else:
		stSaveFig = 'figs/' + versionNumber + stSave + 'FilterDaysWithArrival.png'
else:
	if filterTail:
		stSaveFig = 'figs/' + versionNumber + stSave + 'FilterTailWithArrival.png'
	else:
		stSaveFig = 'figs/' + versionNumber + stSave + 'WithArrival.png'
...
for date in range(len(dateVecIADS)):
	try:
		if dateVecIADS[date] not in excludeVec:
			dfIads = pd.read_csv('data/' + versionNumber + '/' + dateVecIADS[date] + '_iads_summary_'+ versionNumber +'.csv' , sep=',' , index_col=False)
			dfFlightSpecifc = pd.read_csv('data/'+ versionNumber +'/' + dateVecIADS[date] + '_flight_specific_'+ versionNumber +'.csv' , sep=',' , index_col=False)
